# Linearize
Construct a linear, no-fork, best version of the CNS blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install cns_hash

https://github.com/cns/cns_hash
...
JSON-RPC server. Running `cnsd` or `cns-qt -server` will be sufficient.
...
* `input`: cnsd blocks/ directory containing blkNNNNN.dat
