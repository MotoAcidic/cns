...
This document provides guidelines for internationalization of the CNS Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cns_en.ts` remains unchanged.
