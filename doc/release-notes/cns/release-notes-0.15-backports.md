...
- [`f7b71f660`](https://github.com/cns/cns/commit/f7b71f660) Merge #13611: [bugfix] Use `__cpuid_count` for gnu C to avoid gitian build fail.
...
- [`c35aa663b`](https://github.com/cns/cns/commit/c35aa663b) Merge #11326: Fix crash on shutdown with invalid wallet
...
- [`b93785d8d`](https://github.com/cns/cns/commit/b93785d8d) Fix maxuploadtarget.py
...
- [`1b77cc81a`](https://github.com/cns/cns/commit/1b77cc81a) No need to assert wait_until
...
- [`cd5a12f9f`](https://github.com/cns/cns/commit/cd5a12f9f) Merge #10862: Remove unused variable int64_t nEnd. Fix typo: "conditon" → "condition".
...
- [`51a4e11d6`](https://github.com/cns/cns/commit/51a4e11d6) cnsify what made sense in fuzzing.md
...
- [`dfd14bf57`](https://github.com/cns/cns/commit/dfd14bf57) Merge #10977: [net] Fix use of uninitialized value in getnetworkinfo(const JSONRPCRequest&)
...
- [`5dc2193d2`](https://github.com/cns/cns/commit/5dc2193d2) Merge #10824: Avoid unnecessary work in SetNetworkActive
...
- [`9ad533089`](https://github.com/cns/cns/commit/9ad533089) Merge #10803: Explicitly search for bdb5.3.
...
- [`9221e0d3c`](https://github.com/cns/cns/commit/9221e0d3c) Merge #10728: fix typo in help text for removeprunedfunds
...
- [`31f4a602a`](https://github.com/cns/cns/commit/31f4a602a) Merge #9517: [refactor] Switched httpserver.cpp to use RAII wrapped libevents.
...
- [`30c5aaead`](https://github.com/cns/cns/commit/30c5aaead) Merge #10578: Add missing include for atomic in db.h
...
- [`e7d7ecb6e`](https://github.com/cns/cns/commit/e7d7ecb6e) Set a few param values to 0 by default
...
- [`0477eb4b3`](https://github.com/cns/cns/commit/0477eb4b3) Merge #9539: [net] Avoid initialization to a value that is never read
...
- [`c6b926547`](https://github.com/cns/cns/commit/c6b926547) Merge #7958: Remove useless argument to AlertNotify.
...
- [`fc5e461ee`](https://github.com/cns/cns/commit/fc5e461ee) Merge #10222: [tests] test_runner - check unicode
...
- [`b76b91d82`](https://github.com/cns/cns/commit/b76b91d82) Merge #10197: [tests] Functional test warnings
...
- [`6afa605f6`](https://github.com/cns/cns/commit/6afa605f6) Pass disconnected/deleted pindex instead of pprev into BlockDisconnected
...
- [`14001a3d9`](https://github.com/cns/cns/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
...
- [`7edb9e15a`](https://github.com/cns/cns/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/cns/cns/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/cns/cns/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/cns/cns/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/cns/cns/commit/67c735b15) s/bitcoin-config.h/cns-config.h/
- [`2f63322cd`](https://github.com/cns/cns/commit/2f63322cd) cnsify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/cns/cns/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/cns/cns/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/cns/cns/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/cns/cns/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/cns/cns/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/cns/cns/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/cns/cns/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/cns/cns/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/cns/cns/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/cns/cns/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/cns/cns/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/cns/cns/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/cns/cns/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/cns/cns/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/cns/cns/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/cns/cns/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/cns/cns/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/cns/cns/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/cns/cns/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/cns/cns/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/cns/cns/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/cns/cns/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/cns/cns/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/cns/cns/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/cns/cns/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/cns/cns/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/cns/cns/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/cns/cns/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/cns/cns/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/cns/cns/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/cns/cns/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/cns/cns/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/cns/cns/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/cns/cns/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/cns/cns/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/cns/cns/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/cns/cns/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/cns/cns/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/cns/cns/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/cns/cns/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/cns/cns/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/cns/cns/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/cns/cns/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/cns/cns/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/cns/cns/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/cns/cns/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/cns/cns/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/cns/cns/commit/1cfda206a) Merge #9993: Initialize nRelockTime
