...
This mechanism has been integrated into Bitcore-Node-CNS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cns/insight-api-cns#web-socket-api](https://github.com/cns/insight-api-cns#web-socket-api)
* API: [https://github.com/cns/insight-api-cns#instantsend-transactions](https://github.com/cns/insight-api-cns#instantsend-transactions)
