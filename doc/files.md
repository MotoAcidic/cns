...
* cns.conf: contains configuration settings for cnsd or cns-qt
* cnsd.pid: stores the process id of cnsd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by cnsd or cns-qt
