...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 CNS from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 CNS in block rewards plus fees, but
        ...
        # Send 100 CNS with subtract fee from amount
        ...
        # Sendmany 100 CNS with subtract fee from amount
