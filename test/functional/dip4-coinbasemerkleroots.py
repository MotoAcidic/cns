...
from test_framework.test_framework import CNSTestFramework
...
class LLMQCoinbaseCommitmentsTest(CNSTestFramework):
    def set_test_params(self):
        self.set_cns_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as CNSTestFramework doesn't support this atm)
