...
#error Client version information missing: version is not defined by cns-config.h or in any other way
#endif
...
/**
 * cnsd-res.rc includes this file, but it cannot cope with real c++ code.
